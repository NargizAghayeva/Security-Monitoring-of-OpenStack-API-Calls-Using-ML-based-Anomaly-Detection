"""
THESIS: Security Monitoring of OpenStack API Calls Using ML-Based Anomaly Detection
PHASE 1: CICIDS2017 Dataset — EDA, Feature Selection, Autoencoder Pretraining & Evaluation

Output files:
    autoencoder_model.h5
    scaler.pkl
    phase2_feature_mapping.csv
    eda_01_class_distribution.png
    eda_02_feature_distributions.png
    eda_03_outliers.png
    eda_04_correlation_matrix.png
    eda_05_feature_importance.png
    training_loss.png
...
# Remove NaN and invalid values before any analysis
...
# Remove negative Flow Duration (invalid records)
...
# ── CELL 9: Feature Selection — Variance Threshold ───────────────────────────
...
# ── CELL 11: Feature Selection — Random Forest Importance ────────────────────
...
axes[0].set_xlabel('MSE'); axes[0].set_ylabel('Density')
...
# ── CELL 19: Export Feature Mapping for Phase 2 ───────────────────────────────
